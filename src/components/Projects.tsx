...
const Projects = () => {
  const projects = [
    {
      title: "Weather App",
      description: "A responsive weather application that provides real-time weather updates using live API data. Features include temperature, humidity, wind speed, and weather condition icons with a clean UI.",
      image: "weather.png",
    ...
    },
    {
      ...
      description: "Full-stack food delivery platform with a fully developed frontend. Backend features like payments and orders are under development.",
      image: "food.png",
    ...
    },
    {
      ...
      description: "Full-stack shopping app currently under development, focusing on payment processing and order management features.",
      image: "shopping.png",
