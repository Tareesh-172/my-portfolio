      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 flex justify-center">
            <div className="w-64 h-64 rounded-2xl bg-gradient-to-r from-blue-400 to-purple-600 p-1">
              <div className="w-full h-full rounded-2xl bg-slate-800 overflow-hidden">
                <img
                  src="tar.jpg"
                  alt="Profile"
                  className="w-full h-full object-cover object-top scale-199 rounded-2xl"
                />
          ...
          <div className="space-y-8">
            <div className="backdrop-blur-lg bg-white/10 rounded-2xl p-8 border border-white/20">
              ...
              <p className="text-gray-300 leading-relaxed mb-6">
                ...
                I've worked on real-world projects like an e-commerce website and a weather app, 
                using skills like UI/UX design, API integration, and full-stack development.
