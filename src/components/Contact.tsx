...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-b from-slate-800 to-slate-900 relative overflow-hidden">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    rows={6}
                    className="bg-white/10 border-white/20 text-white placeholder:text-gray-400 focus:border-blue-400 focus:ring-blue-400 resize-none"
                  />
                </div>
                <Button
                  type="submit"
                  disabled={isSubmitting}
                  className="w-full bg-gradient-to-r from-purple-500 to-blue-600 hover:from-purple-600 hover:to-blue-700 text-white py-3 rounded-full font-semibold transition-all duration-300 shadow-lg hover:shadow-xl"
                >
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-white font-semibold">tareesh.pasarla@email.com</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-4">
              ...
              <Card className="backdrop-blur-lg bg-white/10 border border-white/20 p-8">
                ...
                <div className="flex space-x-4">
                  <Button
                    variant="outline"
                    size="lg"
                    className="flex-1 border-white/20 text-white hover:bg-white/20 transition-all duration-300 hover:scale-105"
                  ...
                  <Button
                    variant="outline"
                    size="lg"
                    className="flex-1 border-white/20 text-white hover:bg-blue-600 transition-all duration-300 hover:scale-105"
      ...
      <Button
        onClick={scrollToTop}
        className="fixed bottom-8 right-8 bg-gradient-to-r from-purple-500 to-blue-600 hover:from-purple-600 hover:to-blue-700 text-white p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 z-50"
        size="lg"
      >
