      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
            <Card className="backdrop-blur-lg bg-white/10 border border-white/20 p-6 sm:p-8">
            ...
            <div className="space-y-8">
              <Card className="backdrop-blur-lg bg-white/10 border border-white/20 p-6 sm:p-8">
                ...
                <div className="space-y-4">
                  {[
                    { label: 'Email', value: 'tareeshpasarla430@gmail.com', icon: '📧', colors: 'from-blue-500 to-purple-600' },
                    { label: 'Phone', value: '+91 - 7569906172', icon: '📱', colors: 'from-green-500 to-teal-600' },
                    { label: 'Location', value: 'Bangalore', icon: '📍', colors: 'from-orange-500 to-red-600' }
                  ].map((item, i) => (
                    <div key={i} className="flex items-center space-x-4">
                      <div className={`w-12 h-12 bg-gradient-to-r ${item.colors} rounded-full flex items-center justify-center`}>
